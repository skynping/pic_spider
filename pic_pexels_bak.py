...
class pix_spider:
    def __init__(self):
        self.color_lists = ["red","orange","yellow","green","turquoise","blue","violet","pink","brown","black","gray","white"]
...
def main():
    url = "https://www.pexels.com/popular-photos/all-time/"
    # url = "https://www.pexels.com/?dark=false&format=js&page=1&seed=2019-01-16+14%3A02%3A58++0000&format=js&seed=2019-01-16%2014:02:58%20+0000"
    # url = 'https://www.pexels.com/popular-photos/all-time/?page=2&format=js&seed=2019-01-16%2016:07:16%20+0000'
    header = {
    ...
    text_lists = response.text.split("download")[1:]
